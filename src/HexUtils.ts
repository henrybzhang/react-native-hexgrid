...
export class HexUtils {
  ...
  /** Given the q,r,s of a hexagon return the x and y percentage coordinates of the
   * hexagon center.
   * @param {Hex} hex - target Hex
   * @param {LayoutDimensions} layout - layout which contains the Hex
   * @returns {Point} percentage coordinate of the Hex center
   */
  static hexToPercentage(hex: Hex, layout: LayoutDimension): Point {
  ...
  /** Return the q,r,s coordinate of the hexagon given percentage point x and y.
   * @param {Point} point - target percentage coordinates
   * @param {LayoutDimension} layout - layout of the desired
   * @returns {Hex} Hex with coordinate position at the
   */
  static percentageToHex(point: Point, layout: LayoutDimension): Hex {
    const M = layout.orientation;
    const pt = new Point(
